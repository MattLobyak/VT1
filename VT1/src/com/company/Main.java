...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Book book1 = new Book("Philosopher's Stone", "Joanne Rowling", 35, 2);
        Book book2 = new Book("Dreamcatcher", "Stephen King", 18, 3);
        ...
        library1.add(new Book("451 grade fahrenheit", "Ray Bradbury", 29, 1));
        library1.add(new Book("Nineteen Eighty-Four", "George Orwell", 10, 1));
        library1.add(new Book("Brave New World", "Aldous Huxley", 322, 1348));
        library1.add(new Book("The Dark Tower", "Stephen King", 4, 10));
        library1.add(book1);
        library1.add(book2);
